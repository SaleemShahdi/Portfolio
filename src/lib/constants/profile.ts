export const PROFILE_INFO = {
  ...
  about: `
I'm a software engineer driven by the fundamental belief that computing is the most powerful tool for transformative change. From medicine to engineering, the most interesting challenges are being solved with code, and my passion lies in being part of that solution. I thrive on deconstructing complex problems and building elegant, effective software to solve them.
